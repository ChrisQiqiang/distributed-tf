...
def resnet_main(
  ...
  # added by faye
  print('model dir=%s, checkpointing dir=%s', flags_obj.model_dir, flags_obj.pretrained_model_checkpoint_path)
  ...
  for cycle_index, num_train_epochs in enumerate(schedule):
    ...
    # added by faye
    train_spec = tf.estimator.TrainSpec(input_fn=lambda: input_fn_train(num_train_epochs),
