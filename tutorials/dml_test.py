...
# For distributed
tf.app.flags.DEFINE_string("ps_hosts", "172.17.0.2:2222",
                           "Comma-separated list of hostname:port pairs")
tf.app.flags.DEFINE_string("worker_hosts", "172.17.0.3:2222,172.17.0.4:2222",
                           "Comma-separated list of hostname:port pairs")
...
def main(_):
  ...
  if FLAGS.job_name == "ps":
	...
	if step % 100 == 0:
	  ...
	  print ("step: %d, l_step: %d, g_step: %d" %(step, l_step, g_step))
